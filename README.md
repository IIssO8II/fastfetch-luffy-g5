...
Para asegurarte que todo esté correcto, ejecuta "Fastfetch" en tu terminal.

```sh
fastfetch
```
Siéntete libre de modificar lo que quieras y/o agregar imágenes nuevas. para esto, deberás poner la imagen en la carpeta "images" y en config.jsonc cambiar la línea ```"source": "~/.config/fastfetch/images/luffy.png"``` por el nombre de la nueva imagen
